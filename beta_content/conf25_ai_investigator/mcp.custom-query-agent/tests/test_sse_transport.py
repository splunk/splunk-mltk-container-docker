#!/usr/bin/env python3
"""SSE transport test for Custom Query Agent MCP server."""
...
async def test_sse_transport():
    ...
    port = os.getenv("MCP_SERVER_SSE_PORT", "7006")
    ...
    try:
        ...
        print(f"\n{RED}Failed to connect to SSE server:{RESET} {e}")
        results.add_fail("SSE Connection", str(e))
        return False
