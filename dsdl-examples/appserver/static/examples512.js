...
require([
    ...
    $(".dashboard-dashboardpage").attr('id', 'dashboard-particles');
    $(".dashboard-dashboardpage").css("background","#000000");
    $(".dashboard-dashboardpage").css("background-image","linear-gradient(#000000, #371937, #000000)");
    $(".dashboard-body").css("background", "none");  
    $(".dashboard-header-title").css("display","none");
    ...
    DashboardController.onReady(function() {
        ...
        DashboardController.onViewModelLoad(function() {
            ...
            var exampleInfoLoaded = exampleInfoCollection.fetch({
                url: SplunkUtil.make_url('/static/app/' + app +'/examples512.json'),
                cache: true
            });
            ...
            $.when(exampleInfoLoaded).then(function(){
                ...
                _.each(categories, function(category){
                    ...
                    categoryInfoCollection.each(function(exampleInfo){
                        ...
                        var view = undefined;
                        var label = exampleInfo.get('title') || id;
                        ...
                        const versionTag = exampleInfo.get('version-tag');
                        if (exampleInfo.get('version-tag')!=null) {                            
                            var $exampleTags = $('<span class="version">'+versionTag+'</span>').attr('alt',versionTag).appendTo($exampleContent);
                        }
            ...
            particlesJS.load('dashboard-particles', SplunkUtil.make_url('/static/app/' + app +'/particles523.json'), function() {
                console.log('particles523.js config loaded');
            });
