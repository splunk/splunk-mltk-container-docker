...
def test_transformers_finetune_en(playwright: Playwright,containername) -> None:
    ...
    # page.get_by_role("row").locator("div").filter(has_text="| inputlookup classification_en.csv | fields - TITLE ID | rename * as cat1_*, ca").nth(3).click()
    # page.get_by_label("Search", exact=True).fill("\u00014")
    ...
    page.get_by_text("Select languageenSelect base modelbert_classification_enClearTarget model nameBa").click()
    page.get_by_label("Max Epoch").fill("1")
